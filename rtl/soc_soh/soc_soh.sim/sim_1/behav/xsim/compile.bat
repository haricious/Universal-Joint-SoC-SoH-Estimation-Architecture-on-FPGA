...
REM
REM Generated by Vivado on Wed Mar 04 12:29:40 +0530 2026
...
echo "xvlog --incr --relax -prj soc_soh_tb_vlog.prj"
call xvlog  --incr --relax -prj soc_soh_tb_vlog.prj -log xvlog.log
